...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post trackers_url, params: { tracker: { score: @tracker.score, subgenre_id: @tracker.subgenre_id, user_id: @tracker.user_id } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { score: @tracker.score, subgenre_id: @tracker.subgenre_id, user_id: @tracker.user_id } }
